...
if(isset($_GET['id']))
{
  $sql6="SELECT * from `".TBL_PRODUCT."` WHERE `status` = 1 and `category_id`='".$_GET['id']."' ";
}
elseif(isset($_GET['discount1']) && isset($_GET['discount2']))
{
  $sql6="SELECT * from `".TBL_PRODUCT."` WHERE `status` = 1 and `discount`<='".$_GET['discount1']."' and `discount`>='".$_GET['discount2']."' ";
}
else
{
  $sql6="SELECT * from `".TBL_PRODUCT."` WHERE `status` = 1";
}
                        ...
                        <div class="categori-checkbox">
                            <form action="shop1.php" method="post">
                                <ul>
                                    ...
                                    <li><input type="checkbox" name="product-categori" class="common_selector category" value="<?php echo $row['product_brand']; ?>"><a href="shop1.php?id=<?php echo $row['id'] ?>&page=1"><?php echo $row['category_name'] ?></a><span class="count">
                                      (
                                        <?php
                        ...
                        <div class="categori-checkbox">
                            <form action="#">
                                <ul>
                                    ...
                                    ?>
                                    <li><input name="product-categori" type="checkbox"><a href="shop1.php?discount1=90&discount2=61&page=1">90% - 61%</a><span class="count">(<?php echo $row2[0] ?>)</span></li>
                                    <li><input name="product-categori" type="checkbox"><a href="shop1.php?discount1=60&discount2=31&page=1">60% - 31%</a><span class="count">(<?php echo $row3[0] ?>)</span></li>
                                    <li><input name="product-categori" type="checkbox"><a href="shop1.php?discount1=30&discount2=0&page=1">30% - 0%</a><span class="count">(<?php echo $row4[0] ?>)</span></li>
                                </ul>
                            </form>
                        </div>
                    </div>
                                ...
                                <div class="product-pagination">
                                    <ul>
                                      <?php 
                                          ...
                                          { ?> 
                                        <li <?php if($page==$_GET['page']){?> class="active" <?php } ?> ><a href = "shop1.php?page=<?php echo $page ?>"><?php echo $page ?></a></li>
                                        <?php
                                          }?>
                                    </ul>
                                </div>
