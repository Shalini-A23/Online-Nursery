            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">View Category</h4>
                    </div>
                        ...
                        <div class="el-card-item">
                            <div class="el-card-avatar el-overlay-1">
                                ...
                                <div class="el-overlay">
                                        <ul class="el-info">
                                            <li><a class="btn default bg-info" href="category_add_edit.php?id=<?php echo $row['id'] ?>&page=1 ?>"><i class="ti-pencil"></i></a></li>
                                            <li><!--<a onclick="return confirm('Are you sure to DELETE this category?')" class="btn default bg-danger" href="category_action.php?id=<?php echo $row['id'] ?>&delete=4"><i class="ti-trash"></i></a>--><a class="btn default bg-danger"><i class="ti-trash" onclick="archiveFunction(<?php echo $row['id']; ?>)"></i></a></li>
                                            <li><?php if($row['status']=='1'){ ?><a class="btn bg-success" href="category_action.php?active=4&id=<?php echo $row['id'] ?>" style="font-size: 15px;">&starf;</a><?php } else{ ?><a class="btn bg-warning" href="category_action.php?inactive=4&id=<?php echo $row['id'] ?>">&starf;</a><?php } ?></li>

                                        </ul>
                                    </div>
                            </div>
                            <div class="el-card-content">
                                <h3 class="box-title"><b><a href="product_view.php?id=<?php echo $row['id'] ?>"><?php echo $row['category_name'] ?></a></b></h3>
                                <br/> </div>
                        </div>
                    </div>
                    <?php $j++; } ?>
...
function archiveFunction($a) 
{
  ...
  }).then(function(result)
  {
    if (result.value) 
    {
        location.assign("category_action.php?id="+$a+"&delete=4");        // submitting the form when user press yes
    } 
});
}
</script>
